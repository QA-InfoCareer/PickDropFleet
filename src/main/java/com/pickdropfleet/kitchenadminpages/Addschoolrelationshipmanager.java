...
public class Addschoolrelationshipmanager {
	...
	public Addschoolrelationshipmanager(WebDriver driver) {
	...
	////////// Create School Relationship Manager //////////

	public String addSchoolRelationshipManager(String uploadImage, String firstName, String lastName,
		...
		String randomEmail4 = generateRandomEmail4();
		...
		if (autoFillCity4.equals("Chennai") && autoFillState4.equals("Tamilnadu") &&
				...
				autoFillCountry4.equals("India") && autoFillPostalCode4.equals("600028")) {
	...
	public static String generateRandomEmail4() {
		...
		return "relationship" + randomNumber + "@gmail.com";
