...
public class Addrouteadmin {
	...
	By Locationaddress = By.xpath("(//*[name()='svg'][@class='MuiSvgIcon-root MuiSvgIcon-fontSizeMedium css-vubbuv'])[1]"); // it clicks location icon																											// icon
	...
	public Addrouteadmin(WebDriver driver) {
...
//////////Create Route Admin //////////
	...
	public String addRouteAdmin(String uploadImage, String firstName, String lastName,
		...
		List<WebElement> routeAdmin = driver.findElements(By.tagName("li"));

		if (routeAdmin.size() > 0) {

			routeAdmin.get(5).click();
		}
		...
		utils.sendKeysWithExplicitWait(driver, email, randomEmail3, 10); // random email
		...
		String autoFillCity3 = (City).getAttribute("value");
		System.out.println("Auto Fill City : " + autoFillCity3);
		String autoFillState3 = (State).getAttribute("value");
		String autoFillCountry3 = (Country).getAttribute("value");
		String autoFillPostalCode3 = (Postalcode).getAttribute("value");

		if (autoFillCity3.equals("Chennai") && autoFillState3.equals("Tamilnadu") &&

				autoFillCountry3.equals("India") && autoFillPostalCode3.equals("600028")) {
		...
		return "New route admin added";
	}

	public static String generateRandomEmail3() {
		...
		return "routeadmin" + randomNumber + "@gmail.com";
