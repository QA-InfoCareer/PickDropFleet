...
public class Addschooladmin {
	...
	@FindBy(xpath = "(//input[@aria-label='Without label'])[2]")
	WebElement Country; // enter country

	@FindBy(xpath = "(//input[@aria-label='Without label'])[1]")
	WebElement State;
	...
	public Addschooladmin(WebDriver driver) {
...
//////////Create School Admin //////////
	...
	public String addSchoolAdmin(String uploadImage, String firstName, String lastName,
		...
		utils.clickElementWithWait(driver, Schoolname);
		...
		if (options.size() > 0) {
			...
			for (WebElement element : options) {
				...
				if (element.getText().equalsIgnoreCase("HRMS School")) { // school value
		...
		String autoFillCity1 = City.getAttribute("value");
		System.out.println("Auto Fill City : " + autoFillCity1);
		String autoFillState1 = State.getAttribute("value");
		String autoFillCountry1 = Country.getAttribute("value");
		String autoFillPostalCode1 = Postalcode.getAttribute("value");

		if (autoFillCity1.equals("Chennai") && autoFillState1.equals("Tamilnadu") &&

				autoFillCountry1.equals("India") && autoFillPostalCode1.equals("600028")) {
